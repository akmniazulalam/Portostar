  ...
  return (
    <section className="mt-7 mb-12 py-[110px] bg-no-repeat bg-cover bg-center" style={{backgroundImage: `url(${rectangleImage})`}}>
      <Container>
          ...
          <Texts className={"w-1/2"} pText={"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vitae blandit lectus. Praesent at hendrerit velit, at dictum nisl."}/>
